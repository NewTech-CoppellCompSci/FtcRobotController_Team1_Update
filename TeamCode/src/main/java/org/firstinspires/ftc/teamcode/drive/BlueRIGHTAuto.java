...
@Autonomous(name = "blueRIGHTautoNEW", group = "Trajectory", preselectTeleOp = "DriverControl_Pressme;")
...
//        pipeline.setup(hardwareMap);
    ...
    private void scoreFreight() {
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToSplineHeading(new Pose2d(-9, -42, Math.toRadians(0))) //move to storage tower thing
                .build());
        ((DcMotorEx) Lift).setVelocity(liftVelo);
